/** 
 * easyDialogsecond v2.2
 * Url : http://stylechen.com/easydialogsecond-v2.0.html
...
Dialog.prototype = {
	...
	createDialogWrap : function( tmpl ){
		...
		var header = tmpl.header ? 
			'<h4 class="easyDialog_title" id="easyDialogTitle1"><a href="javascript:void(0)" title="关闭窗口" class="close_btn" id="closeBtn">&times;</a>' + tmpl.header + '</h4>' :
			'',
			// 确定按钮
...
var extend = {
	open : function(){
		...
		var closeBtn = doc.getElementById( 'closeBtn' ),
			dialogTitle = doc.getElementById( 'easyDialogTitle1' ),
...
// ------------------------------------------------------
var loaded = function(){
		win.easyDialogsecond = easyDialogsecond();
	},
